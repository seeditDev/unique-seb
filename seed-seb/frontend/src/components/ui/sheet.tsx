...
SheetOverlay.displayName = SheetPrimitive.Overlay.name;
...
SheetContent.displayName = SheetPrimitive.Content.name;
...
SheetTitle.displayName = SheetPrimitive.Title.name;
...
SheetDescription.displayName = SheetPrimitive.Description.name;
